<template>
    <div class="app-container">
        ...
        <el-table :data="tableData" stripe style="width: 100%">
            ...
            <el-table-column prop="hours" label="课时" width="150" />
            <el-table-column prop="tname" label="授课老师" width="300" />
            <el-table-column prop="count" label="学生数量" width="150" />
...
const join=async (cno,cname)=>{
    ...
    let route = {
        name:'处理申诉:'+cname,
        path:`/home/commu/handle${cno}`,
        meta:{
            parentName:'处理申诉'
        },
    }

    route.component = () => import('@/views/commu/handlecourse.vue');
