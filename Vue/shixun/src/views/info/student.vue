<template>
    <div class="app-container">
        ...
        <el-table :data="tableData" stripe style="width: 100%">
            <el-table-column prop="no" label="学号" width="250" />
...
const initUserList=async()=>{
    const res=await requestUtil.post("info/student/list",queryForm.value);
...
const handleDelete=async (sno)=>{
    ...
    const res=await requestUtil.post("info/student/delete",sno)
