<template>
    <div class="app-container">
        ...
        <el-table :data="tableData" stripe style="width: 100%">
            ...
            <el-table-column prop="tname" label="授课老师" width="250" />
            <el-table-column prop="" label="互评情况" width="300" >
                <template v-slot="scope1">
                    <el-text v-if="scope1.row.allrevise-scope1.row.hasrevise!=0">有&nbsp;{{scope1.row.allrevise-scope1.row.hasrevise}}&nbsp;份作业需批改&nbsp;&nbsp;{{scope1.row.revisestatus}}</el-text>
...
const chooseCourse =(cno,cname)=>{
    ...
    let route = {
        name:'互评作业:'+ cname,
        path:`/home/activ/gradeCourse${cno}`,
        meta:{
            parentName:'互评作业'
        },
    }

    route.component = () => import('@/views/activ/gradeCourse.vue');
